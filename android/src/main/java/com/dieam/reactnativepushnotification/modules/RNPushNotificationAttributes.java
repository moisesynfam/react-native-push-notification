...
public class RNPushNotificationAttributes {
    ...
    private static final String CUSTOM_CHANNEL_ID = "customChannelId";
    ...
    private final String customChannelId;
    ...
    public RNPushNotificationAttributes(Bundle bundle) {
        ...
        customChannelId = bundle.getString(CUSTOM_CHANNEL_ID);
    }
    ...
    private RNPushNotificationAttributes(JSONObject jsonObject) {
        try {
            ...
            customChannelId = jsonObject.has(CUSTOM_CHANNEL_ID) ? jsonObject.getString(CUSTOM_CHANNEL_ID) : null;
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(CUSTOM_CHANNEL_ID, customChannelId);
        return bundle;
    }
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jsonObject.put(CUSTOM_CHANNEL_ID, customChannelId);
        } catch (JSONException e) {
